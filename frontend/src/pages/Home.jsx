  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)', color: 'var(--text)' }}>
      ...
      <nav style={{
        ...
        <div className="container" style={{ maxWidth: 1140, display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px 16px' }}>
      ...
      <div className="container" style={{ maxWidth: 1140 }}>
        <div style={{ maxWidth: 700, margin: '0 auto', padding: '48px 16px 40px', textAlign: 'center' }}>
          <div style={{
      ...
      <div style={{ borderTop: '1px solid var(--border)', borderBottom: '1px solid var(--border)' }}>
        <div className="container" style={{ maxWidth: 1140, padding: '0 16px' }}>
      ...
      <div style={{ borderTop: '1px solid var(--border)', background: 'var(--surface)' }}>
        <div className="container" style={{ maxWidth: 1140, padding: '16px 16px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 8 }}>
